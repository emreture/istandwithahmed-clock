//------------------------------------------------------------------------------
// Default 6x8 font for PCD8544 library
// ====================================
//    width			: 6 pixels
//    height		: 1 row (8 pixels)
//    firstASCIIChar: 0x20
//    lastASCIIChar	: 0x7f
//    unknownChar	: '?'
//    data			: 576 bytes (96 characters * 6 bytes/character)
//------------------------------------------------------------------------------
#include "pcd8544.h"

const uint8_t PCD8544_defaultFontData[];

char PCD8544_defaultFontMap[][2] =
{
	{'°', 0x7f},{'Ç', 'C'},{'ç', 'c'},{'Ğ', 'G'},{'ğ', 'g'},{'İ', 'i'},{'ı', 'i'},{'Ö', 'O'},{'ö', 'o'},{'Ş', 'S'},{'ş', 's'},{'Ü', 'U'},{'ü', 'u'}
};

font_t PCD8544_defaultFont = {6, 1, 0x20, 0x7f, PCD8544_defaultFontMap, sizeof(PCD8544_defaultFontMap) / sizeof(*PCD8544_defaultFontMap), '?', (uint8_t*)PCD8544_defaultFontData};
