//------------------------------------------------------------------------------
// Sinclair Spectrum font for PCD8544 library
// ==========================================
//    width			: 8 pixels
...
//    lastASCIIChar	: 0x7e
//    unknownChar	: '?'
//    data			: 760 bytes (95 characters * 8 bytes/character)
// http://www.rinkydinkelectronics.com/r_fonts.php
//------------------------------------------------------------------------------
#include "pcd8544.h"

const uint8_t sinclairFontData[];

char sinclairFontMap[][2] =
{
	{'Ç', 'C'},{'ç', 'c'},{'Ğ', 'G'},{'ğ', 'g'},{'İ', 'i'},{'ı', 'i'},{'Ö', 'O'},{'ö', 'o'},{'Ş', 'S'},{'ş', 's'},{'Ü', 'U'},{'ü', 'u'}
};

font_t sinclairFont = {8, 1, 0x20, 0x7e, sinclairFontMap, sizeof(sinclairFontMap) / sizeof(*sinclairFontMap), '?', (uint8_t*)sinclairFontData};
